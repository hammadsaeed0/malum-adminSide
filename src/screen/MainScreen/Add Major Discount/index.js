...
fetch("https://api.accounts.lighthousepakistan.online/add_major_discount.php", requestOptions)
  .then(response => response.text())
  .then(result => {
    const data = JSON.parse(result);
...
useFocusEffect(
  ...
  return (
    <View style={{flex:1, backgroundColor:Color.white}}>
      ...
      <Text style={{fontSize:responsiveFontSize(2), marginBottom:responsiveHeight(1) ,color:'black', fontWeight:'bold', fontFamily:Font.Regular, marginLeft:responsiveWidth(3), marginTop:responsiveHeight(5)}}>Customer</Text>
      <SelectList 
...
export default AddMajorDiscount