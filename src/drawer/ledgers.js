...
const Ledger = ({navigation}) => {
  ...
  return (
    ...
    <View style={{width:'90%', height:responsiveHeight(5), alignSelf:'center', marginTop:responsiveHeight(2)}}>
    <FlatList 
      horizontal
      data={btn}
      showsHorizontalScrollIndicator={false}
      renderItem={({item})=> 
      <TouchableOpacity style={{width:responsiveWidth(40), height:responsiveHeight(5), backgroundColor:'black', borderRadius:10, marginLeft:10, alignItems:'center', justifyContent:'center'}}>
...
{/* // Customer Card */}
      ...
      <View style={{width:responsiveWidth(90), height:responsiveHeight(8), backgroundColor:'white', alignSelf:'center', flexDirection:'row', justifyContent:'space-between', alignItems:'center', borderRadius:10, elevation:3}}>
