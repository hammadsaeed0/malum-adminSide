  ...
  return (
    <View style={{flex: 1}}>
      <View style={{width:"100%", height:'100%', backgroundColor:'#1F2937'}}>
            ...
            <TouchableOpacity style={{alignItems:"center", justifyContent:'center', width:'70%', height:responsiveHeight(5), backgroundColor:'#f0bc74', alignSelf:"center", borderRadius:10, marginBottom:responsiveHeight(2), flexDirection:'row'}}>
